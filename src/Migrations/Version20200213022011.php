 ...
 */
final class Version20200213022011 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE apply (id INT AUTO_INCREMENT NOT NULL, offers_id INT NOT NULL, student_id INT NOT NULL, hired TINYINT(1) NOT NULL, confirmed TINYINT(1) NOT NULL, refused TINYINT(1) NOT NULL, unavailable TINYINT(1) NOT NULL, INDEX IDX_BD2F8C1FA090B42E (offers_id), INDEX IDX_BD2F8C1FCB944F1A (student_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE studies (id INT AUTO_INCREMENT NOT NULL, school_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_C3A91A3FC32A47EE (school_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offers (id INT AUTO_INCREMENT NOT NULL, company_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, location VARCHAR(255) NOT NULL, domain VARCHAR(255) NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_DA460427979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
