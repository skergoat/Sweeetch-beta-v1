 ...
 */
final class Version20200311110521 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recruit (id INT AUTO_INCREMENT NOT NULL, studies_id INT DEFAULT NULL, student_id INT NOT NULL, hired TINYINT(1) NOT NULL, agree TINYINT(1) NOT NULL, refused TINYINT(1) NOT NULL, unavailable TINYINT(1) NOT NULL, date_recruit DATETIME NOT NULL, finished TINYINT(1) NOT NULL, date_finished DATETIME NOT NULL, INDEX IDX_106B2A6F565186C9 (studies_id), INDEX IDX_106B2A6FCB944F1A (student_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
