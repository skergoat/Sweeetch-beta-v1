 ...
 */
final class Version20200207053258 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, profile_id INT DEFAULT NULL, resume_id INT NOT NULL, id_card_id INT NOT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, zip_code VARCHAR(255) NOT NULL, tel_number VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, driving_license TINYINT(1) DEFAULT NULL, disabled TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_B723AF33A76ED395 (user_id), UNIQUE INDEX UNIQ_B723AF33CCFA12B8 (profile_id), UNIQUE INDEX UNIQ_B723AF33D262AF09 (resume_id), UNIQUE INDEX UNIQ_B723AF3394513350 (id_card_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
